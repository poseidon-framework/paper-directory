...
def generate_html(papers):
    ...
    <body>
      <main>
        ...
        <!-- bubble chart begin -->
        <details>
        <summary role="button">Timeline visualization</summary>
        ...
        <select id="colorMode">
          <option value="community_archive">community-archive highlighted</option>
          <option value="aadr_archive">aadr-archive highlighted</option>
          <option value="minotaur_archive">minotaur-archive highlighted</option>
